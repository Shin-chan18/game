...
pygame.display.set_caption('akit')
...
sound=pygame.mixer.Sound('tv2.wav')
...
while running:
	...
	for tube in tubes :
		if bird.colliderect(tube):
			...
			tube_velocity=0
			bird_drop_velocity=0
			game_over_txt=font1.render("Game over :"+str(score),True,BLUE)
			screen.blit(game_over_txt,(85,260))
			space_txt=font2.render("press space ",True,GREEN)
